...
def print_station(_space_station: SpaceStation) -> None:
	status = "Operational" if _space_station.is_operational else "Not Operational"
	print("========================================")
...
def main() -> None:
	...
	space_station = SpaceStation(station_id="ISS001", name="International Space Station", crew_size=6, power_level=85.5, oxygen=92.3)
	print_station(space_station)

	print("Expected validation error:")
	try:
		invalid_space_station = SpaceStation(station_id="ISS002", name="International Space Station", crew_size=0, power_level=85.5, oxygen=92.3)
